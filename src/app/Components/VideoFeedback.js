            ...
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2'>
                <div className=''>
                    ...
                    <div className=' flex flex-row flex-wrap gap-8 mt-8'>
                        <iframe src="https://drive.google.com/file/d/1kvduCZdAbOWKhsQA9Pb7fXXwUrfxQTm-/preview" width="" height="" allow="autoplay" poster='.\ public\ image.jpg' className='h-96 w-3/4 rounded-2xl '></iframe>
                    </div >
                </div >
